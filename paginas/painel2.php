                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Painel de Controleee
                                    <div class="page-title-subheading">Visão Gerallllll
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card mb-3 widget-content bg-midnight-bloom">
                                <div class="widget-content-wrapper text-white">
                                    <div class="widget-content-left">
                                        <div class="widget-heading">Total de Vendasss</div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card mb-3 widget-content">
                                <div class="widget-content-outer">
                                    <div class="widget-content-wrapper">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Notas a Pagar</div>
                                ...
                                <div class="widget-content-outer">
                                    <div class="widget-content-wrapper">
                                        <div class="widget-content-left">
                                            ...
                                            <div class="widget-subheading">Valor total de produtos em estoque</div>
                                        </div>
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-warning">
                                                ...
                                                R$
                                                <?php                                                
                                                include_once("banco/total_produtos.php");  //inclui a página total_produtos que contém um ECHO com o resultado de um cálculo                                       
                                                ?>
